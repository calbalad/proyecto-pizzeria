...
let map = (val: number, a1: number, a2: number, b1: number, b2: number) => b1 + (val - a1) * (b2 - b1) / (a2 - a1)
...
function cheese(ctx: { beginPath: () => void; lineCap: string; moveTo: (arg0: number, arg1: number) => void; lineTo: (arg0: number, arg1: number) => void; lineWidth: number; stroke: () => void; }, rad: number, multi: number, ii: number, sliceSize: number, sliceDegree: number) {
