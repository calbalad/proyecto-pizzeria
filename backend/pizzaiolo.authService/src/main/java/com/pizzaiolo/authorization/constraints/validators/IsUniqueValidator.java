package com.pizzaiolo.authorization.constraints.validators;

import com.pizzaiolo.authorization.constraints.IsUnique;
...
public class IsUniqueValidator implements ConstraintValidator <IsUnique, Object> {
    ...
    public boolean isValid(final Object value, final ConstraintValidatorContext context) {
        Object result;
        String finalRepositoryName = "com.pizzaiolo.authorization.repositories." + repositoryName;
