...
public class Constants {
    ...
    public static final String SWG_AUTH_LOGIN_EMAIL_EXISTS = "Bad credentials email already exists";
    ...
    public static final String SWG_ADDRESS_TAG_NAME = "Address";
    public static final String SWG_ADDRESS_TAG_DESCRIPTION = "Manage users address";
    public static final String SWG_ADDRESS_CREATE_OPERATION = "Create an address";
    public static final String SWG_ADDRESS_CREATE_MESSAGE = "Address registered successfully!";
    public static final String SWG_ADDRESS_CREATE_ERROR = "Failed to create the address";
    public static final String SWG_ADDRESS_DELETE_OPERATION = "Delete an address";
    public static final String SWG_ADDRESS_DELETE_MESSAGE = "Address deleted successfully!";
}