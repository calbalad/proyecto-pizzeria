...
CREATE TABLE `Order` (
  ...
  `idUser` varchar(120) COLLATE utf8_spanish_ci NOT NULL,
  `orderDate` datetime NOT NULL,
  `deliveryDate` datetime DEFAULT NULL,
  `comment` text CHARACTER SET utf8 COLLATE utf8_spanish_ci,
  `idChef` varchar(120) COLLATE utf8_spanish_ci DEFAULT NULL,
  `idCourier` varchar(120) COLLATE utf8_spanish_ci DEFAULT NULL,
...
-- Dump completed on 2022-03-11 16:40:59
